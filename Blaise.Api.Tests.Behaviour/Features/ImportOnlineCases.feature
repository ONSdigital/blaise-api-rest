...
@smoke
# Covers all scenarios in one test run - https://officefornationalstatistics.atlassian.net/wiki/spaces/QSS/pages/50306805/OPN+NISRA+Case+Processing+Scenarios
