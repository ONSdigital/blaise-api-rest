...
namespace Blaise.Api.Tests.Behaviour.Helpers.Configuration
{
    ...
    {
        public static bool RunLocal => RestApiConfigurationHelper.RunLocalUsingStubs;
        public static string ServerParkName => RunLocal ? "gustyTest" : ConfigurationExtensions.GetEnvironmentVariable("ServerParkName");
        public static string InstrumentPath => ConfigurationExtensions.GetEnvironmentVariable("InstrumentPath");
        public static string InstrumentName => RunLocal ? "opnTest" : ConfigurationExtensions.GetEnvironmentVariable("InstrumentName");
        ...
        public static string InstrumentFile => RunLocal ? "instrumentFileTest" : $"{InstrumentName}.{InstrumentExtension}";
