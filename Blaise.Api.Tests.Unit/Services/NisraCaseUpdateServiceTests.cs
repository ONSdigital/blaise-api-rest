...
namespace Blaise.Api.Tests.Unit.Services
{
    public class NisraCaseUpdateServiceTests
    {
        ...
        public void Given_The_Case_Is_Not_Open_In_Cati_And_The_Record_Gets_Updated_When_I_Call_UpdateCase_Then_The_Update_Is_Logged()
        {
            ...
            // assert
            _loggingMock.Verify(
                v => v.LogInfo($"NISRA case '{_primaryKey}' was successfully updated for questionnaire '{_questionnaireName}'"),
                Times.Once);
        ...
        public void Given_The_Case_Is_Not_Open_In_Cati_And_The_Record_Does_Not_Get_Updated_When_I_Call_UpdateCase_Then_A_Warning_Is_Logged()
        {
            ...
            // assert
            _loggingMock.Verify(
                v => v.LogWarn($"NISRA case '{_primaryKey}' failed to update - potentially open in Cati at the time of the update for questionnaire '{_questionnaireName}'"),
                Times.Once);
        }
